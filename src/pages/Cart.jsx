            ...
            <div className="lg:col-span-1">
              <div className="bg-white p-6 shadow-sm sticky top-4">
                ...
                <Button
                  ...
                  className="w-full bg-green-800 hover:bg-green-700 text-neutral-white py-4 inline-flex items-center justify-center gap-2 transform transition-all duration-300 mb-3"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                ...
                <Button
                  ...
                  variant="outline"
                  size="md"
                  className="w-full inline-flex items-center justify-center gap-2 py-4 text-center"
                >
                  Continue Shopping
                </Button>
